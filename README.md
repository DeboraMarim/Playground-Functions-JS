...
<details>
  ...
  - Use o comando: `git clone https://github.com/DeboraMarim/Playground-Functions-JS.git`
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-027-b-project-playground-functions`
  ...
  - Crie uma branch à qual você vai submeter os `commits` de seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-027-b-project-playground-functions`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-027-b-project-playground-functions`
...
- Lembrem-se que como pessoas desenvolvedoras devemos fazer pesquisas e garimpar resultados para auxiliar no entendimento do assunto. Assim, para solucionar os requisitos do projeto é inevitável e estimulado que pesquisas sejam feitas nas mais variadas fontes (google, youtube, etc) sempre tomando cuidado para utilizar fontes **confiáveis** nas pesquisas da Internet, como por exemplo:
...
A função `splitSentence` recebe uma string como parâmetro e deve retornar um array com as palavras separadas por vírgula.
  ...
  Exemplo: se a função receber a string `'Ola Amigo'`, o retorno deverá ser `['Ola', 'Amigo']`.

**O que será testado:**
  
- A função `splitSentence` deve retornar o valor `['Ola', 'Amigo']` quando receber como parâmetro a string `'Ola Amigo'`;
...
## 13 - Crie uma função de boas vindas ao Bar!
